;~@sa1
;this is the right bottom-half cap cannon of a horizontal 2-way pipe.
;behaves $130
...
exit:
	...
	LDA.b #!SSP_PipeTimer_CannonExit_Rightwards	;\set exit the pipe timer (same as smw's $7E0088)
	STA !Freeram_SSP_PipeTmr			;/
