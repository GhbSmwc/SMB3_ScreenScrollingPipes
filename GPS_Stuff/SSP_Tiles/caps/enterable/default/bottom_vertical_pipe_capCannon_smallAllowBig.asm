;~@sa1
;This is the bottom left-half cap cannon of a vertical two-way pipe.
;behaves $130
...
;timer = 25 if super on yoshi
	...
	LDA.b #!SSP_PipeTimer_CannonExit_Downwards_OffYoshi_SmallMario	;\Small mario's timer
	BRA .StoreTimer							;/
.BigMario
	LDA.b #!SSP_PipeTimer_CannonExit_Downwards_OffYoshi_BigMario		;\Big mario's timer
	if !Setting_SSP_YoshiAllowed != 0
		BRA .StoreTimer							;/
		...
		LDA.b #!SSP_PipeTimer_CannonExit_Downwards_OnYoshi_SmallMario		;\Small on yoshi's timer
		BRA .StoreTimer							;/
		
		.BigMarioYoshi
		LDA.b #!SSP_PipeTimer_CannonExit_Downwards_OnYoshi_BigMario		;>big on yoshi's timer
	endif
.StoreTimer
...
if !Setting_SSP_Description != 0
	print "A bottom small pipe cap cannon that Mario of any powerup can enter and exit."
endif